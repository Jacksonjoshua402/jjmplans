  ...
  return [
    {
      ...
      description: 'Read at least one chapter and take notes',
      frequency: 'daily',
      priority: 'high',
      status: 'in-progress',
      progress: 70,
    ...
    },
    {
      ...
      description: 'Personal development & professional books',
      frequency: 'monthly',
      priority: 'medium',
      status: 'pending',
      progress: 30,
    ...
    {
      id: uuidv4(),
      title: 'Practice Speaking in Tongues',
      description: 'At least 30 minutes daily',
      frequency: 'daily',
      priority: 'high',
      status: 'in-progress',
      progress: 85,
    ...
    },
    {
      ...
      description: 'Finish all modules on Udemy',
      frequency: 'weekly',
      priority: 'high',
      status: 'in-progress',
      progress: 45,
    ...
    },
    {
      ...
      description: 'Budget & track expenses daily',
      frequency: 'monthly',
      priority: 'medium',
      status: 'pending',
      progress: 50,
